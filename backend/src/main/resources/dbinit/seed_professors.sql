...
WITH prof_seed(name, surname, email, password_hash, short_name) AS (
    VALUES ('Ѓорѓи', 'Маџаров', 'gjorgji.madzharov@finki.ukim.mk', 'password', 'GM'),
                                                                               ...
                                                                               ('Моника', 'Симјаноска', 'monika.simjanoska@finki.ukim.mk', '', 'MS'),
                                                                               ...
                                                                               ('Војдан', 'Ќорвезироски', 'vojdan.kjorveziroski@finki.ukim.mk', '', 'VK'),
                                                                               ...
                                                                               ('Евгенија', 'Крајчевска', 'evgenija.krajchevska@finki.ukim.mk', '', 'EK'),
